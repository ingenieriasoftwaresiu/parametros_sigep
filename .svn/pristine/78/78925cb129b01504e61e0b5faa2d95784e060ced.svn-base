...
import co.edu.udea.parametrossigep.dao.EjecucionPptalProyectoDAO;
...
import co.edu.udea.parametrossigep.dao.impl.ComunesDAOImpl;
import co.edu.udea.parametrossigep.dao.impl.EjecucionPptalProyectoDAOImpl;
import co.edu.udea.parametrossigep.dao.impl.EtapaDAOImpl;
import co.edu.udea.parametrossigep.dao.impl.FuncionesComunesDAOImpl;
import co.edu.udea.parametrossigep.dao.impl.NotificacionMailDAOImpl;
import co.edu.udea.parametrossigep.dao.impl.ParametroGeneralDAOImpl;
import co.edu.udea.parametrossigep.dao.impl.PersonaDAOImpl;
import co.edu.udea.parametrossigep.dao.impl.ProyectoDAOImpl;
        ...
        */
        ...
        if ((proyectos != null) && (proyectos.size() > 0)){
            ...
            for (Proyecto proyecto : proyectos){
                ...
                System.out.println("Código proyecto: " + strIdProyecto);
                ...
                if (notificarProyecto == Boolean.TRUE){                                        
                    ...
                    */
                    ...
                    if (etapa != null){
                        ...
                        System.out.println("Nro. de días: " + lgNumDias);
                                                
                       if (lgNumDias >= 0){      // Si el proyecto ya finalizó, se debe poner comentario en esta instrucción ya que los días darán negativos.                                                    
